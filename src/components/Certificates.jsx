...
date: 'Dec 2023',
link: '#',
desc: 'Deleniti, consectetur? Est itaque, libero vero voluptatibus.',
},
{
id: 3,
title: 'Lorem ipsum dolor sit amet consectetur adipi',
...
return ( <section
   ...
   id="certificates" > 
   <div className="max-w-7xl mx-auto px-6 lg:px-16"> <div className="mb-16"> <p className="text-primary text-sm uppercase tracking-widest mb-2 font-semibold">Achievements </p>
